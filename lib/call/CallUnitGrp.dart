...
// }
//
// class GrpUnit extends StatefulWidget {
//   List streams = [];
//   dynamic myCurrentOffer;
//
//
...
//   void Function() callbackCamera;
//   void Function() callbackSCreenShare;
//
//   GrpUnit(
//       {this.partnerPair,
//         this.ownID,
...
//         this.isCaller,
//         this.firestore,
//         this.containsVideo,this.callback,this.callbackCamera,this.callbackSCreenShare,this.isScreenSharing,this.cameraALlreadyOpen});
//
//   @override
//   _MyHomePageState createState() => _MyHomePageState();
// }
//
// class _MyHomePageState extends State<GrpUnit>
...
//     });
//     CallButonsClickStreamScreen.getInstance().outData.listen((event) {
//       handelScreenShaing(event);
//     });
//
...
//           setState(() {
//             _remoteRendererAudio.srcObject = stream ;
//             widget.containsVideo = widget.cameraALlreadyOpen;
//           });
//
//
//         //  handleCameraToggle(widget.cameraALlreadyOpen);
//         //  handelScreenShaing(widget.isScreenSharing);
//
//
//         }else
//
...
//     //FirebaseFirestore.instance.collection("queu").doc(widget.partnerPair).set({"room":room});
//   }
//   void handelScreenShaing(bool status) async{
//     setState(() {
//       widget.isScreenSharing = status;
//     });
...
//
//   }
//   void handleCameraToggle(bool status)async {
//
//     setState(() {
//       widget.containsVideo = status;
//     });
